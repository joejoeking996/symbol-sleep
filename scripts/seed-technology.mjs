/**
 * Standalone script to seed the Technology page into the database.
 * Run with: node scripts/seed-technology.mjs
 */
...
// Dynamic import because Payload config uses TypeScript
async function main() {
  ...
  // Check if technology page already exists and delete it
  ...
  const page = await payload.create({
    ...
    data: {
      ...
      meta: {
        description: 'Explore the advanced materials and technologies behind Symbol Mattresses. From quilt layers to support systems, discover how every layer contributes to better sleep.',
